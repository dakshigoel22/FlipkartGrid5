...
function Trending() {
  ...
  const trending = useSelector(store => store.dashboard.trending)
  ...
  return <div class="product-showcase">
    ...
    <div class="showcase-wrapper  has-scrollbar">
      <div class="showcase-container">
        ...
        { trending && trending.slice(0, 4).map((product) => <div class="showcase">
      ...
      { trending && trending.length > 4 && <div class="showcase-container">
        { trending(4, 4).map((product) => <div class="showcase">
